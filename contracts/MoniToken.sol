...
contract MoniToken is IERC20 {
  ...
  function _initialTransfer() private{
    _transfer(address(this), 0xe0E7a8b6Fcd7c37CE6768D57DCf18b8100e5C8D4, 16_200_000 * 1_000_000_000_000_000_000); // PrivateSale
    _transfer(address(this), 0x1382E0Ac5e01D4181483bEB384c0e09dd671717E, 2_700_000 * 1_000_000_000_000_000_000); // IDO
    _transfer(address(this), 0xDA18Eb309D418Ca9Fe2929a233fd67DC1f3EF489, 2_700_000 * 1_000_000_000_000_000_000); // Liquidity
    _transfer(address(this), 0xe2665d26A2B136c916f4BaCF4b61D5c529D37f5b, 13_500_000 * 1_000_000_000_000_000_000); // BLaunchPad
  }
